...
#ifndef BASICPROJECTMEDEASHAREDDATA_H
#define BASICPROJECTMEDEASHAREDDATA_H

class BasicProjectMedeaSharedData {
...
//	static int gMaxEvaluation; //! how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; //! if true, ignore gEnergyPointRespawnLagMaxValue and use tailored BasicProjectMedea update version.
