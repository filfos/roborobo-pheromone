...
*/
// download from : http://www.ferzkopp.net/joomla/content/view/19/14/ (20090102)
...
// (niko.20090406)    DLLINTERFACE void gfxPrimitivesSetFont(const void *fontdata, int cw, int ch);
