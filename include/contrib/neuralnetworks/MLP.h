...
namespace Neural {
	...
	class MLP : public LayeredNeuralNetwork {
		...
		public:
			...
			MLP(unsigned int nbInputs, unsigned int nbOutputs, std::vector<unsigned int>& nbNeuronsPerHiddenLayer, bool activeBiais = false, bool onlyUseBiaisForFirstHiddenLayer = false, double biaisValue = 1.0);
