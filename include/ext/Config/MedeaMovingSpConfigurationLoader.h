/*
 * MedeaMovingSpConfigurationLoader.h
 *
...
#ifndef MEDEAMOVINGSPCONFIGURATIONLOADER_H
#define	MEDEAMOVINGSPCONFIGURATIONLOADER_H

#include "Config/ConfigurationLoader.h"

class MedeaMovingSpConfigurationLoader : public ConfigurationLoader
{
	public:
		MedeaMovingSpConfigurationLoader();
		~MedeaMovingSpConfigurationLoader();
