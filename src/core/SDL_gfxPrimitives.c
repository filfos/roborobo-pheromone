...
#include "Utilities/SDL_gfxPrimitives_font.h"
...
int arcColor(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 r, Sint16 start, Sint16 end, Uint32 color)
{
    ...
    Uint8 *colorptr;
    Uint8 drawoct;
    int startoct = 0, endoct = 0, oct = 0, stopval_start = 0, stopval_end = 0;
    double temp = 0;
...
/*
// (niko.20090406): commented because compile error on linux, and not used: "src/core/SDL_gfxPrimitives.c:4306: erreur: invalid conversion from const void* to const unsigned char*" 
